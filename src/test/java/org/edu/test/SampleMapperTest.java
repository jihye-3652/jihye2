...
public class SampleMapperTest {
	...
	* INSERT INTO member VALUES ('user2','1234','kimjihye','user02@test.com',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
	* 프로젝트폴더경로 DbInterface/src/main/webapp/WEB-INF/spring/root-context.xml (Mysql서버접속정보 변경해야 합니다.)
	...
	@Inject
	private IF_SampleMapper mapper;//인터페이스를 실행가능하게 //구형 웹프로그램 => IF_SampleMapper mapper; = new IF_SampleMapper
	...
	public void testUpdateMember() {
		...
		MemberVO vo = new MemberVO(); 
		//ㄴ> 수정은 여러개의 변수값을 변경하기 때문에 MemverVO클래스 변수를 매개변수로 사용한다.
		vo.setUserid("user12");
		vo.setUserpw("4321");
		vo.setUsername("stevan");
